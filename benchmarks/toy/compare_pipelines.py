...
Reads results.csv from each plots/toy/{pipeline}/ directory and produces:
...
Usage:
    python benchmarks/toy/compare_pipelines.py \
        --plots_dir plots/toy \
        --out_dir   plots/toy/comparison
"""
...
def main():
    ...
    parser.add_argument('--plots_dir', default='plots/toy')
    parser.add_argument('--out_dir',   default='plots/toy/comparison')
