...
#   --wrap="$ACTIVATE && $RUN main.py fit \
#     --config configs/TESS/train_tess_s4d_reconstruction.yaml \
#     --data.init_args.data_dir $DATA_DIR \
#     --trainer.callbacks[1].init_args.dirpath $CKPT_DIR/tess_s4d_reconstruction")
...
#     --data.init_args.data_dir $DATA_DIR \
#     --trainer.callbacks[1].init_args.dirpath $CKPT_DIR/tess_mlp_regression")
...
#     --data.init_args.data_dir $DATA_DIR \
#     --trainer.callbacks[1].init_args.dirpath $CKPT_DIR/tess_mlp_classification")
...
#     --data.init_args.data_dir $DATA_DIR \
#     --trainer.callbacks[1].init_args.dirpath $CKPT_DIR/tess_s4d_regression")
...
#     --data.init_args.data_dir $DATA_DIR \
#     --trainer.callbacks[1].init_args.dirpath $CKPT_DIR/tess_s4d_classification")
...
#     --trainer.callbacks[1].init_args.dirpath $CKPT_DIR/tess_s4d_head_regression")
...
#     --data.init_args.data_dir $DATA_DIR \
#     --model.init_args.backbone_ckpt $CKPT_DIR/tess_s4d_reconstruction/best.ckpt \
#     --trainer.callbacks[1].init_args.dirpath $CKPT_DIR/tess_s4d_head_classification")
