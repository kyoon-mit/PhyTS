...
---------------------
TESS_DATA_DIR   Override for --data_dir (default: data/TESS/.cache/TESS/split)
...
from tasks.TESS.pytorch_checkpoint import TESSPyTorchModelCheckpoint
