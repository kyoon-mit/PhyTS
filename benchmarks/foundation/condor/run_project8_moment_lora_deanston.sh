#!/usr/bin/env bash
# MOMENT LoRA on Project 8 (cavity noise, full 24576 cutoff) for deanston
...
# script because the existing deanston pattern runs locally on the node
# rather than via the Condor scheduler.
#
# Usage (on deanston):
#   bash benchmarks/foundation/condor/run_project8_moment_lora_deanston.sh
#
...
LOG="${LOG_DIR}/deanston_p8_moment_lora_${TS}.log"
