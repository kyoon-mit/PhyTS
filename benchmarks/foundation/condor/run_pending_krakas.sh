#!/usr/bin/env bash
# Direct-run script for krakas (24 GiB).
# Cells: Project 8 Full-FT for chronos, moment, timesfm — sequential.
#
# Usage (after `ssh krakas`):
#   bash benchmarks/foundation/condor/run_pending_krakas.sh
set -u
...
for m in chronos moment timesfm; do
